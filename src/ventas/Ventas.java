...
public class Ventas extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel4.add(buscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 40, 140, 30));

        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/productos/campo-buscar.png"))); // NOI18N
        jPanel4.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 30, 210, -1));
        ...
        tablaVentas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "CODIGO", "DESCRIPCIÓN", "CANTIDAD", "$PRECIO", "$TOTAL"
            }
        ) {
    ...
    private void btnVenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVenderActionPerformed
        ...
        if (this.tablaVentas.getRowCount() < 1) {
            ...
            for (int i = 0; i < this.tablaVentas.getRowCount(); i++) {
                ...
                String prod =tablaVentas.getValueAt(i,3).toString()+"     "+ tablaVentas.getValueAt(i, 2).toString()+"         "+ tablaVentas.getValueAt(i, 4).toString()+"\n";
                pila.push(prod);
                t = new Ticket(numVenta.getText(),txtFecha.getText(),pila,lblTotal.getText());
    ...
    private void buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyReleased
        Opciones.listarV(this.buscar.getText());
